...
#       Updated             18/11/2015
#       Prerequisites - File ModelFile.txt, stop-words-english.txt, StopDocumentFrequencyTerms.txt and two folders Test\\Class1 and Test\\Class2 available
...
print 'Size of Model file in KB -', str((os.path.getsize('ModelFile.txt')/1000))
