...
#       Updated             18/11/2015
#       Pre-requisites - Two local folders Class1 and Class2 are available in folder where program is run, StopDocumentFrequencyTerms.txt, stop-words-english.txt also present 
#       Output will be program Diff_Document_Frequency_words_100 which will contain Dictionary for Class 1 and Class 2 items
...
diffresultfrequency('Diff_Document_Frequency_words_100.txt',words_sum_data_sorted_ds1, 100)
