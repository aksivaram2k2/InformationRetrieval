...
#       Output will be program Diff_Document_Frequency_words_50 which will contain Dictionary for Class 1 and Class 2 items
...
diffresultfrequency('Diff_Document_Frequency_words_50.txt',words_sum_data_sorted_ds1, 50)
