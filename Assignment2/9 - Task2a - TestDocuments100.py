...
#       Updated             18/11/2015
#       Prerequisites - File ModelFile100.txt, stop-words-english.txt, StopDocumentFrequencyTerms.txt and two folders Test\\Class1 and Test\\Class2 available
...
with open("ModelFile100.txt") as f:
    for line in f:
...
print 'Size of Model file in KB -', str((os.path.getsize('ModelFile100.txt')/1000))
